...
$FioOutputObj = Invoke-RestMethod -Uri "http://192.168.201.129:8080/fiojson?size=500m&numjobs=$($NUMFILES)&rw=rw&blocksize=4k&ioengine=sync&directory=/tmp&runtime=60"
